...
if ($errorr )
{
	if ($errorr) 
    {
        ...
        echo '</Processing><meta http-equiv="refresh" content="10; url = ./wallet.php" ?>'; 
	}
 ...
 echo '<br><h1 style="color:green">SUCCESS</h1><meta http-equiv="refresh" content="10; url = ./wallet.php" ?>';
